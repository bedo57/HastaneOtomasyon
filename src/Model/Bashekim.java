...
public class Bashekim extends User{
    ...
    public ArrayList<User> getDoctorList(){
        ...
        try {
            ...
            rs = st.executeQuery("Select * from hospital.user Where type ='doktor'");
            while (rs.next()){
    ...
    public ArrayList<User> getClinicDoctorList(int clinic_id) throws SQLException{
        ...
        try {
            st = con.createStatement();
            rs = st.executeQuery("Select u.id, u.tcno, u.name, u.password, u.type FROM hospital.worker w LEFT JOIN hospital.user u ON w.user_id = u.id WHERE clinic_id= " + clinic_id);
            while (rs.next()){
    ...
    public boolean addDoctor(String tcno, String name, String password) throws SQLException {
